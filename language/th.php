...
return array(
  ...
  'Import' => 'นำเข้า',
  'Import Personnel Information' => 'นำเข้าข้อมูลรายชื่อบุคลากร',
  'Import personnel list' => 'นำเข้ารายชื่อบุคลากร',
  ...
  'Select the :file file to import the personnel list. (Please use the file in this format only)' => 'เลือกไฟล์ :file เพื่อนำเข้ารายชื่อบุคคลากร (กรุณาใช้ไฟล์ในรูปแบบที่กำหนดนี้เท่านั้น)',
  ...
  'The recipient is listed in the selected group can be downloaded (You can select multiple groups)' => 'สมาชิกในกลุ่มผู้รับที่เลือกสามารถดาวน์โหลดเอกสารได้ (สามารถเลือกได้หลายกลุาม)',
